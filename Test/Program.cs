...
namespace CHI.Test
{
    ...
    : this(URL, null, 0)
        ...
        public TestWebSiteApi(string URL, string proxyAddress, int proxyPort) : base(URL, proxyAddress, proxyPort)
        {
            ...
            var r2 = TryGetPatientDataFromPlan("2751530822000157", ExaminationType.Dispanserizacia1, 2019, out var webPlanPatientData);
            ...
            var r5 = TryAddPatientToPlan(srzPatientId, ExaminationType.Dispanserizacia1, 2019);

            var r6 = TryAddStep(ExaminationStep.FirstBegin, new DateTime(2019, 10, 25), 0, 0, webPlanPatientData.Id);
            var r7 = TryAddStep(ExaminationStep.FirstEnd, new DateTime(2019, 10, 28), 0, 0, webPlanPatientData.Id);
            var r8 = TryAddStep(ExaminationStep.FirstResult, new DateTime(2019, 10, 28), HealthGroup.First, Referral.None, webPlanPatientData.Id);
